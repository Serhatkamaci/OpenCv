...
while True:
    ...
    colors = np.array(colors)  # 2 boyutlu bir matrise cevirdim.
    colors = np.tile(colors, (18, 1))  # Renk matrisini buyuttum .

    model = cv2.dnn.readNetFromDarknet("D:\OpenCV\Yolo Algoritmasi\Pratrained_models\yolov3.cfg",
                                       "D:\OpenCV\Yolo Algoritmasi\Pratrained_models\yolov3.weights")  # Veri yapisini olusturdum.
